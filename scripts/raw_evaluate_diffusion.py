...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_path', type=str, default='../logs_sample/raw_sampling_20240509_161526/')
    ...
    args.evaluate_logdir = misc.get_new_log_dir(args.evaluate_logdir, prefix='raw_evaluate')
