...
def deal_ours(results):
    index = 0
    ligand_filename = Globals.reference_results[index][0]["ligand_filename"]
...
def main():
    ...
    if filter_flag:
        print("\n------------------  filter the result  ------------------")
        Globals.ours_results = [r for pr in Globals.ours_results for r in pr]
